...
function doLose()
{
    ...
    alert("Вы проиграли\nВаш результат: " + level + " уровней за " + begSecond + " секунд.");
...
function addSquares()
{
    ...
    //const styles = `flex: 0 0 auto; width: ${w}px; height: ${w}px; border: 1px solid black; cursor: pointer; border-radius: 5px; margin: 3px;`; // Стиль для квадратов
    ...
    for (let i = 0; i < n; i++) {
        ...
        // Функция, вызыв. при клике по квадрату (надо бы вынести наружу)
